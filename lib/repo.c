...
void seafile_encryption_info_set_magic (SeafileEncryptionInfo* self,
                                        const gchar* value);
const gchar* seafile_encryption_info_get_pwd_hash (SeafileEncryptionInfo* self);
void seafile_encryption_info_set_pwd_hash (SeafileEncryptionInfo* self,
                                           const gchar* value);
...
{
	g_return_if_fail (self != NULL);
	if (g_strcmp0 (value, seafile_encryption_info_get_pwd_hash (self)) != 0) {
		gchar* _tmp0_;
		_tmp0_ = g_strdup (value);
