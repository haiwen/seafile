...
static const char *transfer_task_error_strs[] = {
    ...
    "No permission to access remote repository",
    "Repo doesn't exist on the remote end",
    "Internal error when starting to send revision information",
    "Internal error when starting to get revision information",
    "Failed to upload revision information to remote repository",
    "Failed to get revision information from remote repository",
    "Internal error when starting to send file information",
    "Internal error when starting to get file information",
    "Incomplete file information in the local repository",
    "Failed to upload file information to remote repository",
    "Failed to get file information from remote repository",
    "Incomplete file information in the local repository",
    "Internal error when starting to update remote repository",
    "Others have concurrent updates to the remote repository. You need to sync again.",
    "Storage quota full",
    "Server failed to check storage quota",
    "Transfer protocol outdated. You need to upgrade seafile."
    "Incomplete revision information in the local repository"
};
